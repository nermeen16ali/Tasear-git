...
//                 counter.innerHTML = `
//                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
//                         <path d="M4.25213 12.5C..." fill="#004B31"/>
//                     </svg>
//                 `;
//             }
//             else if (stepNum === currentStep) {
...
//         /* ===== Buttons (DISPLAY + TEXT only) ===== */
//         if (currentStep === 1) {
//             prevBtn.classList.add('d-none');
//             nextBtn.classList.remove('d-none');
//             nextText.textContent = 'التالي';
//         }
//         else if (currentStep === totalSteps) {
//             prevBtn.classList.remove('d-none');
//             nextBtn.classList.remove('d-none');
//             nextText.textContent = 'طلب التقرير - الإنتقال إلي طرق الدفع';
//         }
//         else {
//             prevBtn.classList.remove('d-none');
//             nextBtn.classList.remove('d-none');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    nextBtn.addEventListener('click', () => {
        if (currentStep < totalSteps) {
            ...
            window.location.href = 'products-total-pricing-orders.html';
        }
    });
    ...
    function updateStepper() {
        ...
        stepperItems.forEach(item => {
            ...
            if (stepNum < currentStep) {
                item.classList.add('completed');
                item.classList.remove('active');
                counter.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
